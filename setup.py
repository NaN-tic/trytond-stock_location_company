...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-stock_location_company',
    download_url='https://github.com:nantic/trytond-stock_location_company.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-stock_location_company.git'
    },
    classifiers=[
